                        ...
                        <div class="card-body border-bottom py-3">
                            <div class="row ms-5">
                                <form class="row" action="<?php if (isset($update_data)) {
                                                                echo base_url('admin/category/category/update');
                                                            } else {
                                                                echo base_url('admin/category/category/add');
                                                            } ?>" method="post">
                                    <div class="col-md-4">
                                        <label class="form-label" for="prd">Name : </label>
                                        <input class="form-control" type="text" id="category" name="name" value="<?php if (isset($update_data)) {
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div>
                                                        <a class="btn btn-primary" href="<?= base_url('admin/category/category/edit/') . $data['id'] ?>">
                                                    ...
                                                    <div class="mt-2">
                                                        ...
                                                        <a class="btn btn-danger" onclick="return confirm('Are you sure want to Delete.?');" href="<?= base_url('admin/category/category/delete/') . $data['id'] ?>">
