    ...
    <div class="page-body">
        <div class="mx-4">
            <div class="sectiontocopy d-none">
                <div class="row">
                    <input type="hidden" name="odid[]" value="0">
                    <div class="col-sm-2">
            ...
            <div class="card">
                ...
                <div class="card-body border-bottom py-3">
                    <form class="row" action="<?php echo base_url('admin/order/index/update'); ?>" method="post">
                        ...
                        <div class="container mt-4">
                            <div class="row">
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-select select2 customer_id" name="customer_id">
                                            ...
                                            ?>
                                                <option value=" <?= $value->cid; ?>" data-number="<?= $value->number; ?>" <?php if (isset($update_data) && $value->cid == $update_data[0]['customer_id']) {
                                                                                                                                echo 'selected';
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <input class="form-control number" type="number" name="number" data-number="55" readonly placeholder=" Customer number" value="<?php if (isset($update_data)) {
                                                                                                                                                                        echo $update_data[0]['number'];
                                                                                                                                                                    } ?>" />
                            ...
                            <div class="parent my-4" id="paste">
                                <div class="">
                                    ...
                                    ?>
                                        <div class="row">
                                            <input type="hidden" name="odid[]" value="<?php if (isset($update_data)) {
                                                                                            echo $row['odid'];
                                                                                        } ?>">
                                            <div class="col-sm-2">
                                                <label class="form-label">Product :</label>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group">
                                                    <label class="form-label">Quantity :</label>
                                                    <input class="form-control quantity" data-mqty="5555" type="number" name="quantity[]" id="quantity" placeholder="product quantity" value="<?php echo $row['quantity'] ?>" />
                        ...
                        <div class="row my-2">
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="totalquantity" name="totalquantity" placeholder="totalquantity" readonly value="<?php if (isset($update_data)) {
                                                                                                                                                echo $update_data[0]['total_quantity'];
                                                                                                                                            } ?>" />
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.product_id,.quantity,.price,.customer_id', function() {
            ...
            var refnumber = $(this).parent().parent().parent();
            var number = refnumber.find(":selected").data('number');
            refnumber.find(".number").val(number);
